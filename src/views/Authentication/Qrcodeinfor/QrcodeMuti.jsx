...
class QrcodeMuti extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
        };
    ...
    Steapqrcode= () => {
        this.props.history.push('/auth/SteapqrMuti');
      };
    render() {
                        ...
                        <Col className="ml-auto mr-auto" lg="8" md="8">
                            <Card>
                                <CardHeader className="text-center">
                                    <CardTitle tag="h4">Build Your QR Code Muti Voucher</CardTitle>
                                </CardHeader>
                                <Row>
                                    {/* co ben trai */}
                                    <Col sm={12} md={12}>
