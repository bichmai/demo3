...
class ModalVnd extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      Vnd: [],
  ...
  render() {
    ...
    return (
      <>      
        {/* Modal DepositVnd */}
        <Modal isOpen={sVnd} toggle={fVnd} size="lg">
          <Container fluid >
            <Row >
              <Col md="12">
                        ...
                        <Container fluid>
                          <Row>
                            <Col md="12">
                              ...
                              <p className="text-left">Goldennet nhận hàng ngàn dòng tiền mỗi ngày.
                              ...
                              <Button className="pull-right" color="primary" >Verify</Button>
                            </Col>
                          </Row>
                        </Container>
                      </TabPane>
